      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Metadata Editor Portal</h1>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Gestão de Metadados</p>
                <p className="text-xs text-gray-600">Edite e gerencie metadados de tabelas e colunas</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-500">
            © 2024 Metadata Editor Portal. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </div>
